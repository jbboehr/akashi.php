...
final class PublicApiBoundaryTest extends TestCase
{
    ...
    private const PUBLIC_TYPE_CATEGORIES = [
        'entry points' => [
            ...
            \jbboehr\Akashi\Integration\PHPStan\PhpStanCommandVerifier::class,
            \jbboehr\Akashi\Integration\PHPStan\PhpStanExampleConfiguration::class,
            \jbboehr\Akashi\Integration\PHPStan\PhpStanExternalFixturePlanner::class,
            ...
            \jbboehr\Akashi\Integration\PhpUnit\PhpUnitExampleSuite::class,
            \jbboehr\Akashi\Integration\PhpUnit\PhpUnitRuntime::class,
            \jbboehr\Akashi\Integration\PhpUnit\VerifiesPhpUnitExampleSuite::class,
            ...
            \jbboehr\Akashi\Source\NamedExampleSelector::class,
        ...
        'canonical model' => [
            ...
            \jbboehr\Akashi\Model\CorpusExampleId::class,
            ...
            \jbboehr\Akashi\Model\NamedExampleId::class,
            \jbboehr\Akashi\Model\LegacyMarkerName::class,
        ...
        'PHPStan command model' => [
            \jbboehr\Akashi\Integration\PHPStan\PhpStanCommandNotCompleted::class,
            \jbboehr\Akashi\Integration\PHPStan\PhpStanCommandOutputRejected::class,
        ...
        'exceptions' => [
            ...
            \jbboehr\Akashi\Markdown\Exception\DuplicateNamedExampleIdException::class,
            \jbboehr\Akashi\Markdown\Exception\InvalidNamedExampleMetadataException::class,
            \jbboehr\Akashi\Markdown\Exception\NamedExampleOnNonPhpFenceException::class,
            \jbboehr\Akashi\Markdown\Exception\OrphanedNamedExampleMetadataException::class,
            \jbboehr\Akashi\Model\InvalidNamedExampleIdException::class,
            ...
            \jbboehr\Akashi\Source\Exception\NamedExampleNotFoundException::class,
