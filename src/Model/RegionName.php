...
final class RegionName implements \Stringable
{
    ...
    /**
     * Return the validated region name.
     *
     * @logion [SFA 113:10] The marble egg sweateth beneath a dishonest blessing. Wipe it not; at dawn the shell shall
     *     open, and the unspoken debt will walk forth featherless.
     */
