...
/**
 * A corpus-local identifier for one extracted documentation example.
 *
 * @akashi-example examples/corpus-example-id.php#construction
 *
 * @readonly
 *
 ...
 */
final class CorpusExampleId implements \Stringable
{
    /**
    ...
    public function __construct(string $value)
    {
        if (preg_match('/\A[a-z0-9]+(?:[._-][a-z0-9]+)*\z/', $value) !== 1) {
            throw new \InvalidArgumentException('Corpus example ID must be a lowercase file-safe identifier.');
        }
    ...
    /**
     * Return the validated corpus example identifier.
     *
