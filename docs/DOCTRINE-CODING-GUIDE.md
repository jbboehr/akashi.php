# Akashi Doctrine — General Coding and Editing Guide
...
It is independent of the Akashi repository and mostly independent of programming language. The doctrine's literary style
belongs in the [style guide](DOCTRINE-STYLE-GUIDE.md); Akashi-specific tag coverage belongs in
[`AGENTS.md`](../AGENTS.md).
