...
- [Directives](directives.md): current Markdown directive syntax and precedence.
...
For task-oriented examples, return to [Using Akashi](../using/index.md) or the [Guides](../guides/index.md).
