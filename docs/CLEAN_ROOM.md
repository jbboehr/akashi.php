...
`RuleTestCase`, Infection include-interceptor, and Composer archiver inspections recorded above, no dependency source
code or internal tests were consulted. PHPUnit, PHPStan and its extensions, PHP-CS-Fixer, and Infection remain
development-only dependencies; PHPUnit and PHPStan are suggested optional integrations for consumers.
